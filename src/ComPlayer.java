...
class ComPlayer extends JPanel {
...
ComPlayer(ButtonPanel buttonPanel) {
...
void tryWords (Tile[][] theBoard) {   // this method finds "anchors"
        for (int i = 0; i < 15; i++) {
                int y = 0;
                for (int j = 0; j < 15; j++) {
...
void putWords (String s, int x, int y, Tile[][] theBoard) { /////////////////////////
